...
const SingleProduct = () => {
  ...
  const singleProductLoadingStatus = useSelector(
    (state) => state.singleProduct.singleProductLoadingStatus
  );
  ...
  console.log(product);
  return <>{setContent(singleProductLoadingStatus, View, product)}</>;
};
    ...
    <>
      ...
      <div className="single-product">
        ...
        <div className="single-product-info">
          <p className="single-product-info__label">
            {data?.singleProduct.title}
          </p>
          <p
            className="single-product-info__rating"
            dangerouslySetInnerHTML={{
              __html: renderRatingStars(data?.singleProduct.rating.rate),
            }}
          ></p>
          <p className="single-product-info__price">
            PRICE: <span>{data?.singleProduct.price} $</span>
          </p>
          <p className="single-product-info__description">
            {data?.singleProduct.description}
          </p>
          <p className="single-product-info__count">
            REMAINING <span>{data?.singleProduct.rating.count}</span>
          </p>
